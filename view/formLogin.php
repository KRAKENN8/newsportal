...
<head>
    ...
    <title>Login to Account // CYBERPULSE</title>
    <!-- Google Fonts -->
...
<div class="cp-auth-card">
    <div class="cp-auth-header">
        ...
        <p class="cp-auth-subtitle">Log in to Account</p>
    </div>

    <form method="POST" action="loginAnswer">
        <div class="cp-form-group">
            <label for="name" class="cp-form-label"><i class="fa fa-user"></i> E-Mail Address</label>
            <input id="name" type="text" class="cp-form-control" name="name" placeholder="e.g. QuantumDev@cyberpulse.ee" required autofocus>
        </div>

        <div class="cp-form-group">
            <label for="password" class="cp-form-label"><i class="fa fa-lock"></i> Password</label>
