            ...
            <tbody>
                ...
                if (!empty($comments)) {
                    foreach ($comments as $row) {
                        ...
                        echo '    <a href="commentDel?id=' . $row['id'] . '" class="btn-action btn-action-delete" data-confirm="Are you sure you want to permanently delete comment #' . $row['id'] . '? This action cannot be undone." data-confirm-title="Purge Comment #' . $row['id'] . '" data-confirm-subtitle="ADMIN MODERATION" data-confirm-btn="Purge Comment" data-confirm-type="danger" title="Delete comment"><i class="fa fa-trash"></i> Delete</a>';
                        echo '  </td>';
                        echo '</tr>';
                    }
                } else {
