            ...
            <tbody>
                ...
                if (!empty($comments)) {
                    foreach ($comments as $row) {
                        ...
                        echo '    <a href="commentDel?id=' . $row['id'] . '" class="btn-action btn-action-delete" onclick="return confirm(\'Permanently delete comment #' . $row['id'] . '?\');" title="Delete comment"><i class="fa fa-trash"></i> Delete</a>';
                        echo '  </td>';
                        echo '</tr>';
                    }
                } else {
